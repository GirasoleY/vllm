...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Experimental owner-sharded symmetric-memory DCP sparse-indexer merge.
    "VLLM_DCP_TOPK_SYMM": lambda: bool(int(os.getenv("VLLM_DCP_TOPK_SYMM", "0"))),
