...
if TYPE_CHECKING:
    ...
    VLLM_KIMI_K3_LATENT_AR_OVERLAP_MAX_TOKENS: int = 0
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Experimental Kimi-K3 latent all-reduce/shared-MLP overlap. Zero disables
    # it; 512 covers the current DSpark target graph shapes.
    "VLLM_KIMI_K3_LATENT_AR_OVERLAP_MAX_TOKENS": lambda: int(
        os.getenv("VLLM_KIMI_K3_LATENT_AR_OVERLAP_MAX_TOKENS", "0")
    ),
