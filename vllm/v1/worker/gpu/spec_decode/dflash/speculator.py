...
class DFlashSpeculator(DraftModelSpeculator):
    ...
    def __init__(self, vllm_config: VllmConfig, device: torch.device):
        ...
        # A prefill-only producer stores the draft context KV for the KV
        # connector to ship, without drafting tokens.
        self.context_kv_only = self.speculative_config.is_dspark_prefill_only()
